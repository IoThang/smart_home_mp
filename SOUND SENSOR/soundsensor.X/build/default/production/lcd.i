...
void LCDPutStr2(const char *str, char _pos, char _line);
void LCDPutStr3(const char *str, char _line);
# 45 "lcd.c" 2
void LCD_Initialize()
{
...
void LCDPutStr2(const char *str, char _pos, char _line)
{
    ...
    LCDPutCmd((_line == 1) ? (0xC0 | _pos) : (0x80 | _pos));
