 ...
 *ap = __va_start();
 ...
 while((c = *f++)) {
  ...
  for(;;) {
   switch(*f) {
# 596 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
   case '0':
    flag |= 0x04;
    f++;
    continue;
...
# 614 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
...
# 1331 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
   for(c = 1 ; c != sizeof dpowers/sizeof dpowers[0] ; c++)
    if(val < dpowers[c])
     break;
# 1407 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
  if(width > c)
   width -= c;
  else
   width = 0;
  ...
  if(flag & 0x04) {
# 1441 "C:\\Program Files\\Microchip\\xc8\\v2.36\\pic\\sources\\c90\\common\\doprnt.c"
   if(width)
    do
     ((*sp++ = ('0')));
    while(--width);
